    ...
    matchUtilities(
        {
            ...
            'border-l-pcvw': createUtility('border-left-width', PC_WIDTH),
            ...
            'min-h-pcvw': createUtility('min-height', PC_WIDTH),
            'max-w-pcvw': createUtility('max-width', PC_WIDTH),
            'pt-pcvw': createUtility('padding-top', PC_WIDTH),
            'pb-pcvw': createUtility('padding-bottom', PC_WIDTH),
            ...
            'border-l-spvw': createUtility('border-left-width', SP_WIDTH),
            ...
            'min-h-spvw': createUtility('min-height', SP_WIDTH),
            'max-w-spvw': createUtility('max-width', SP_WIDTH),
            'pt-spvw': createUtility('padding-top', SP_WIDTH),
            'pb-spvw': createUtility('padding-bottom', SP_WIDTH),
